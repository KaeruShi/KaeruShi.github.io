  ...
  return (
    ...
    >
      ...
      <motion.p
        ...
        // Optional: ensures the animation only happens once
        viewport={{ once: true }}
        className="text-center text-xl mb-5 md:mb-0"
      >
      ...
      >
        <img
          onClick={() => window.open("https://instagram.com/kaerushi_", "_blank")}
        ...
        />
        <img
          onClick={() => window.open("https://facebook.com/kaerushi404", "_blank")}
